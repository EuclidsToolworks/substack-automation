...
|**New Window Sills**|We've had all the windows in the house and the front and sliding back door replaced.  Everything was getting long in the tooth since everything was from 2001 when we built the house.  I'm finishing the new sills which I had replaced with solid pine instead of pressed paper.  I'll be mixing and tinting the shellac to match the fireplace mantel and wooden blinds. *[See Window Sill posts](/tag/window-sills)*<br>![New Window Sills](https://euclidstoolworks.github.io/substack-automation/assets/window-sills.jpg)|
